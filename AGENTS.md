...
8. **The DSH GUI is a control surface, not a public service.** Port 3080 is published on the vpn-gateway bound to localhost; remote access goes through an existing reverse proxy, not a new open port.
