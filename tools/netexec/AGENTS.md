...
| Item | Value |
|---|---|
| Binaries | `/opt/pen-venv/bin/nxc` and `/opt/pen-venv/bin/netexec` (identical wrappers) |
...
| Protocol DB navigator | `/opt/pen-venv/bin/nxcdb` |
...
| Modules | `/opt/pen-venv/lib/python3.11/site-packages/nxc/modules/` |
...
```
File "/opt/pen-venv/lib/python3.11/site-packages/nxc/protocols/smb.py", line 45, in <module>
    from nxc.protocols.smb.dpapi import collect_masterkeys_from_target, …
File "/opt/pen-venv/lib/python3.11/site-packages/nxc/protocols/smb/dpapi.py", line 2, in <module>
